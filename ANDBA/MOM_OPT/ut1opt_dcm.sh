...
#SBATCH --job-name=dCALC.TADF.ANDBA.MOM_OPT.ut1opt_dcm.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA/MOM_OPT/ut1opt_dcm.in /data/mewes/CALC/TADF/ANDBA/MOM_OPT/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA/MOM_OPT/ut1opt_dcm.out ] && cp /data/mewes/CALC/TADF/ANDBA/MOM_OPT/ut1opt_dcm.out /data/mewes/CALC/TADF/ANDBA/MOM_OPT/ut1opt_dcm.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save ut1opt_dcm.in /data/mewes/CALC/TADF/ANDBA/MOM_OPT/ut1opt_dcm.out ut1opt_dcm.out.plots
else
$QC/bin/qchem ut1opt_dcm.in /data/mewes/CALC/TADF/ANDBA/MOM_OPT/ut1opt_dcm.out
fi
