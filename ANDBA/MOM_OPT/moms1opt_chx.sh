...
#SBATCH --job-name=dCALC.TADF.ANDBA.MOM_OPT.moms1opt_chx.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA/MOM_OPT/moms1opt_chx.in /data/mewes/CALC/TADF/ANDBA/MOM_OPT/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA/MOM_OPT/moms1opt_chx.out ] && cp /data/mewes/CALC/TADF/ANDBA/MOM_OPT/moms1opt_chx.out /data/mewes/CALC/TADF/ANDBA/MOM_OPT/moms1opt_chx.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save moms1opt_chx.in /data/mewes/CALC/TADF/ANDBA/MOM_OPT/moms1opt_chx.out moms1opt_chx.out.plots
else
$QC/bin/qchem moms1opt_chx.in /data/mewes/CALC/TADF/ANDBA/MOM_OPT/moms1opt_chx.out
fi
