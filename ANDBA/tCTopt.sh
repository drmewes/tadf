...
#SBATCH --job-name=WAGNERBORS.ANDBA.QCHEM.tCTopt.in
#SBATCH -t 3-0:00
#SBATCH -n 4
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /home/mewes/CALC/WAGNERBORS/ANDBA/QCHEM/tCTopt.in /home/mewes/CALC/WAGNERBORS/ANDBA/QCHEM/*.mol .

# Backup old out file is existing 
[ -e /home/mewes/CALC/WAGNERBORS/ANDBA/QCHEM/tCTopt.out ] && cp /home/mewes/CALC/WAGNERBORS/ANDBA/QCHEM/tCTopt.out /home/mewes/CALC/WAGNERBORS/ANDBA/QCHEM/tCTopt.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 tCTopt.in /home/mewes/CALC/WAGNERBORS/ANDBA/QCHEM/tCTopt.out tCTopt.out.plots
else
$QC/bin/qchem -np 1 tCTopt.in /home/mewes/CALC/WAGNERBORS/ANDBA/QCHEM/tCTopt.out
fi
