...
#SBATCH --job-name=WAGNERBORS.ANDBA.QCHEM.s2opt.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /home/mewes/CALC/WAGNERBORS/ANDBA/QCHEM/s2opt.in /home/mewes/CALC/WAGNERBORS/ANDBA/QCHEM/*.mol .

# Backup old out file is existing 
[ -e /home/mewes/CALC/WAGNERBORS/ANDBA/QCHEM/s2opt.out ] && cp /home/mewes/CALC/WAGNERBORS/ANDBA/QCHEM/s2opt.out /home/mewes/CALC/WAGNERBORS/ANDBA/QCHEM/s2opt.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 s2opt.in /home/mewes/CALC/WAGNERBORS/ANDBA/QCHEM/s2opt.out s2opt.out.plots
else
$QC/bin/qchem -np 1 s2opt.in /home/mewes/CALC/WAGNERBORS/ANDBA/QCHEM/s2opt.out
fi
