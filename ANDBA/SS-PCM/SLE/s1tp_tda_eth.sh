...
#SBATCH --job-name=dCALC.TADF.ANDBA.SS-PCM.SLE.s1tp_tda_eth.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA/SS-PCM/SLE/s1tp_tda_eth.in /data/mewes/CALC/TADF/ANDBA/SS-PCM/SLE/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA/SS-PCM/SLE/s1tp_tda_eth.out ] && cp /data/mewes/CALC/TADF/ANDBA/SS-PCM/SLE/s1tp_tda_eth.out /data/mewes/CALC/TADF/ANDBA/SS-PCM/SLE/s1tp_tda_eth.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save s1tp_tda_eth.in /data/mewes/CALC/TADF/ANDBA/SS-PCM/SLE/s1tp_tda_eth.out s1tp_tda_eth.out.plots
else
$QC/bin/qchem s1tp_tda_eth.in /data/mewes/CALC/TADF/ANDBA/SS-PCM/SLE/s1tp_tda_eth.out
fi
