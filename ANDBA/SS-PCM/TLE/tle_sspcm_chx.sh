...
#SBATCH --job-name=dCALC.TADF.ANDBA.SS-PCM.TLE.tle_sspcm_chx.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA/SS-PCM/TLE/tle_sspcm_chx.in /data/mewes/CALC/TADF/ANDBA/SS-PCM/TLE/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA/SS-PCM/TLE/tle_sspcm_chx.out ] && cp /data/mewes/CALC/TADF/ANDBA/SS-PCM/TLE/tle_sspcm_chx.out /data/mewes/CALC/TADF/ANDBA/SS-PCM/TLE/tle_sspcm_chx.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save tle_sspcm_chx.in /data/mewes/CALC/TADF/ANDBA/SS-PCM/TLE/tle_sspcm_chx.out tle_sspcm_chx.out.plots
else
$QC/bin/qchem tle_sspcm_chx.in /data/mewes/CALC/TADF/ANDBA/SS-PCM/TLE/tle_sspcm_chx.out
fi
