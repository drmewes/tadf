...
#SBATCH --job-name=.data.mewes.CALC.TADF.ANDBA-Cz.t4opt.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-Cz/t4opt.in /data/mewes/CALC/TADF/ANDBA-Cz/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA-Cz/t4opt.out ] && cp /data/mewes/CALC/TADF/ANDBA-Cz/t4opt.out /data/mewes/CALC/TADF/ANDBA-Cz/t4opt.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 t4opt.in /data/mewes/CALC/TADF/ANDBA-Cz/t4opt.out t4opt.out.plots
else
$QC/bin/qchem -np 1 t4opt.in /data/mewes/CALC/TADF/ANDBA-Cz/t4opt.out
fi
