...
#SBATCH --job-name=.data.mewes.CALC.TADF.ANDBA-Cz.s1opt_tda_soc_rlx.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-Cz/s1opt_tda_soc_rlx.in /data/mewes/CALC/TADF/ANDBA-Cz/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA-Cz/s1opt_tda_soc_rlx.out ] && cp /data/mewes/CALC/TADF/ANDBA-Cz/s1opt_tda_soc_rlx.out /data/mewes/CALC/TADF/ANDBA-Cz/s1opt_tda_soc_rlx.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 s1opt_tda_soc_rlx.in /data/mewes/CALC/TADF/ANDBA-Cz/s1opt_tda_soc_rlx.out s1opt_tda_soc_rlx.out.plots
else
$QC/bin/qchem -np 1 s1opt_tda_soc_rlx.in /data/mewes/CALC/TADF/ANDBA-Cz/s1opt_tda_soc_rlx.out
fi
