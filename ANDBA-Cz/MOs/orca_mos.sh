...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-Cz/orca_mos.in /data/mewes/CALC/TADF/ANDBA-Cz/*.hess /data/mewes/CALC/TADF/ANDBA-Cz/*.gbw /data/mewes/CALC/TADF/ANDBA-Cz/*.xyz .

# Execute the program
$ORCA_PATH/orca orca_mos.in > /data/mewes/CALC/TADF/ANDBA-Cz/orca_mos.out
