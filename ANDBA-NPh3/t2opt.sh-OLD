...
#SBATCH --job-name=.data.mewes1.CALC.TADF.ANDBA-NPh3.t2opt.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/TADF/ANDBA-NPh3/t2opt.in /data/mewes1/CALC/TADF/ANDBA-NPh3/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/TADF/ANDBA-NPh3/t2opt.out ] && cp /data/mewes1/CALC/TADF/ANDBA-NPh3/t2opt.out /data/mewes1/CALC/TADF/ANDBA-NPh3/t2opt.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 t2opt.in /data/mewes1/CALC/TADF/ANDBA-NPh3/t2opt.out t2opt.out.plots
else
$QC/bin/qchem -np 1 t2opt.in /data/mewes1/CALC/TADF/ANDBA-NPh3/t2opt.out
fi
