...
#SBATCH --job-name=.data.mewes1.CALC.TADF.ANDBA-NPh3.MOM_OPT.moms1opt_dcm.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/TADF/ANDBA-NPh3/MOM_OPT/moms1opt_dcm.in /data/mewes1/CALC/TADF/ANDBA-NPh3/MOM_OPT/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/TADF/ANDBA-NPh3/MOM_OPT/moms1opt_dcm.out ] && cp /data/mewes1/CALC/TADF/ANDBA-NPh3/MOM_OPT/moms1opt_dcm.out /data/mewes1/CALC/TADF/ANDBA-NPh3/MOM_OPT/moms1opt_dcm.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 moms1opt_dcm.in /data/mewes1/CALC/TADF/ANDBA-NPh3/MOM_OPT/moms1opt_dcm.out moms1opt_dcm.out.plots
else
$QC/bin/qchem -np 1 moms1opt_dcm.in /data/mewes1/CALC/TADF/ANDBA-NPh3/MOM_OPT/moms1opt_dcm.out
fi
