...
#SBATCH --job-name=dCALC.TADF.ANDBA-NPh3.MOM_OPT.moms1opt_tol.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/TADF/ANDBA-NPh3/MOM_OPT/moms1opt_tol.in /data/mewes1/CALC/TADF/ANDBA-NPh3/MOM_OPT/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/TADF/ANDBA-NPh3/MOM_OPT/moms1opt_tol.out ] && cp /data/mewes1/CALC/TADF/ANDBA-NPh3/MOM_OPT/moms1opt_tol.out /data/mewes1/CALC/TADF/ANDBA-NPh3/MOM_OPT/moms1opt_tol.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 moms1opt_tol.in /data/mewes1/CALC/TADF/ANDBA-NPh3/MOM_OPT/moms1opt_tol.out moms1opt_tol.out.plots
else
$QC/bin/qchem -np 1 moms1opt_tol.in /data/mewes1/CALC/TADF/ANDBA-NPh3/MOM_OPT/moms1opt_tol.out
fi
