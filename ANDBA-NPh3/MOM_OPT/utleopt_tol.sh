...
#SBATCH --job-name=dCALC.TADF.ANDBA-NPh3.MOM_OPT.utleopt_tol.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 utleopt_tol.in /data/mewes/CALC/TADF/ANDBA-NPh3/MOM_OPT/utleopt_tol.out utleopt_tol.out.plots
else
$QC/bin/qchem -np 1 utleopt_tol.in /data/mewes/CALC/TADF/ANDBA-NPh3/MOM_OPT/utleopt_tol.out
fi
