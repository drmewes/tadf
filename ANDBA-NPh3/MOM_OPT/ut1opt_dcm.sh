...
#SBATCH --job-name=dCALC.TADF.ANDBA-NPh3.MOM_OPT.ut1opt_dcm.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 ut1opt_dcm.in /data/mewes1/CALC/TADF/ANDBA-NPh3/MOM_OPT/ut1opt_dcm.out ut1opt_dcm.out.plots
else
$QC/bin/qchem -np 1 ut1opt_dcm.in /data/mewes1/CALC/TADF/ANDBA-NPh3/MOM_OPT/ut1opt_dcm.out
fi
