...
# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save moms1opt_dcm.in /data/mewes1/CALC/TADF/ANDBA-NPh3/MOM_OPT/moms1opt_dcm.out moms1opt_dcm.out.plots
else
$QC/bin/qchem moms1opt_dcm.in /data/mewes1/CALC/TADF/ANDBA-NPh3/MOM_OPT/moms1opt_dcm.out
fi
