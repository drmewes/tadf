...
#SBATCH --job-name=dCALC.TADF.DIANDBA.gsopt.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/DIANDBA/gsopt.in /data/mewes/CALC/TADF/DIANDBA/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/DIANDBA/gsopt.out ] && cp /data/mewes/CALC/TADF/DIANDBA/gsopt.out /data/mewes/CALC/TADF/DIANDBA/gsopt.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save gsopt.in /data/mewes/CALC/TADF/DIANDBA/gsopt.out gsopt.out.plots
else
$QC/bin/qchem gsopt.in /data/mewes/CALC/TADF/DIANDBA/gsopt.out
fi
