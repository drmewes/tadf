...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-OMe+Ethyl/orca_mos.in /data/mewes/CALC/TADF/ANDBA-OMe+Ethyl/*.hess /data/mewes/CALC/TADF/ANDBA-OMe+Ethyl/*.gbw /data/mewes/CALC/TADF/ANDBA-OMe+Ethyl/*.xyz .

# Execute the program
$ORCA_PATH/orca orca_mos.in > /data/mewes/CALC/TADF/ANDBA-OMe+Ethyl/orca_mos.out
