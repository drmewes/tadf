...
#SBATCH --job-name=.data.mewes1.CALC.TADF.ANDBA-OMe+Ethyl.PLOTS.TRIPLETS.plot_triplets.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/TADF/ANDBA-OMe+Ethyl/PLOTS/TRIPLETS/plot_triplets.in /data/mewes1/CALC/TADF/ANDBA-OMe+Ethyl/PLOTS/TRIPLETS/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/TADF/ANDBA-OMe+Ethyl/PLOTS/TRIPLETS/plot_triplets.out ] && cp /data/mewes1/CALC/TADF/ANDBA-OMe+Ethyl/PLOTS/TRIPLETS/plot_triplets.out /data/mewes1/CALC/TADF/ANDBA-OMe+Ethyl/PLOTS/TRIPLETS/plot_triplets.out_OLD

# Execute the program
if [ "yes" = "yes" ] ; then
$QC/bin/qchem -save -np 1 plot_triplets.in /data/mewes1/CALC/TADF/ANDBA-OMe+Ethyl/PLOTS/TRIPLETS/plot_triplets.out plot_triplets.out.plots
else
$QC/bin/qchem -np 1 plot_triplets.in /data/mewes1/CALC/TADF/ANDBA-OMe+Ethyl/PLOTS/TRIPLETS/plot_triplets.out
fi
