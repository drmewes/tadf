...
#SBATCH --job-name=dCALC.TADF.iDBP-DiEt-NPh3.tfreeopt.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/iDBP-DiEt-NPh3/tfreeopt.in /data/mewes/CALC/TADF/iDBP-DiEt-NPh3/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/iDBP-DiEt-NPh3/tfreeopt.out ] && cp /data/mewes/CALC/TADF/iDBP-DiEt-NPh3/tfreeopt.out /data/mewes/CALC/TADF/iDBP-DiEt-NPh3/tfreeopt.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save tfreeopt.in /data/mewes/CALC/TADF/iDBP-DiEt-NPh3/tfreeopt.out tfreeopt.out.plots
else
$QC/bin/qchem tfreeopt.in /data/mewes/CALC/TADF/iDBP-DiEt-NPh3/tfreeopt.out
fi
