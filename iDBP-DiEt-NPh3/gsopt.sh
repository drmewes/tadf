...
#SBATCH --job-name=dCALC.TADF.iDBP-DiEt-NPh3.gsopt.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/iDBP-DiEt-NPh3/gsopt.in /data/mewes/CALC/TADF/iDBP-DiEt-NPh3/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/iDBP-DiEt-NPh3/gsopt.out ] && cp /data/mewes/CALC/TADF/iDBP-DiEt-NPh3/gsopt.out /data/mewes/CALC/TADF/iDBP-DiEt-NPh3/gsopt.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save gsopt.in /data/mewes/CALC/TADF/iDBP-DiEt-NPh3/gsopt.out gsopt.out.plots
else
$QC/bin/qchem gsopt.in /data/mewes/CALC/TADF/iDBP-DiEt-NPh3/gsopt.out
fi
