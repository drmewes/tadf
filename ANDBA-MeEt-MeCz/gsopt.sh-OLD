...
#SBATCH --job-name=dCALC.tadf.ANDBA-MeEt-MeCz.gsopt.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/gsopt.in /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/gsopt.out ] && cp /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/gsopt.out /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/gsopt.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save gsopt.in /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/gsopt.out gsopt.out.plots
else
$QC/bin/qchem gsopt.in /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/gsopt.out
fi
