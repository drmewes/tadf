...
#SBATCH --job-name=dCALC.tadf.ANDBA-MeEt-MeCz.MOM_OPT.ut1opt_eth.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/MOM_OPT/ut1opt_eth.in /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/MOM_OPT/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/MOM_OPT/ut1opt_eth.out ] && cp /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/MOM_OPT/ut1opt_eth.out /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/MOM_OPT/ut1opt_eth.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save ut1opt_eth.in /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/MOM_OPT/ut1opt_eth.out ut1opt_eth.out.plots
else
$QC/bin/qchem ut1opt_eth.in /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/MOM_OPT/ut1opt_eth.out
fi
