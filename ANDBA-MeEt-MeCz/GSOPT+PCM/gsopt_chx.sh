...
#SBATCH --job-name=dCALC.tadf.ANDBA-MeEt-MeCz.GSOPT+PCM.gsopt_chx.in
#SBATCH -t 3-0:00
#SBATCH -n 4
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/GSOPT+PCM/gsopt_chx.in /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/GSOPT+PCM/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/GSOPT+PCM/gsopt_chx.out ] && cp /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/GSOPT+PCM/gsopt_chx.out /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/GSOPT+PCM/gsopt_chx.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save gsopt_chx.in /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/GSOPT+PCM/gsopt_chx.out gsopt_chx.out.plots
else
$QC/bin/qchem gsopt_chx.in /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/GSOPT+PCM/gsopt_chx.out
fi
