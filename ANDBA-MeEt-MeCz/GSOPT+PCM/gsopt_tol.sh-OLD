...
#SBATCH --job-name=dCALC.tadf.ANDBA-MeEt-MeCz.GSOPT+PCM.gsopt_tol.in
#SBATCH -t 3-0:00
#SBATCH -n 4
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/GSOPT+PCM/gsopt_tol.in /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/GSOPT+PCM/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/GSOPT+PCM/gsopt_tol.out ] && cp /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/GSOPT+PCM/gsopt_tol.out /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/GSOPT+PCM/gsopt_tol.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save gsopt_tol.in /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/GSOPT+PCM/gsopt_tol.out gsopt_tol.out.plots
else
$QC/bin/qchem gsopt_tol.in /data/mewes1/CALC/tadf/ANDBA-MeEt-MeCz/GSOPT+PCM/gsopt_tol.out
fi
