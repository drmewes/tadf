...
#SBATCH --job-name=.data.mewes1.CALC.tadf.DONORS.DiEt_ACR.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/DONORS/DiEt_ACR.in /data/mewes1/CALC/tadf/DONORS/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/DONORS/DiEt_ACR.out ] && cp /data/mewes1/CALC/tadf/DONORS/DiEt_ACR.out /data/mewes1/CALC/tadf/DONORS/DiEt_ACR.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save DiEt_ACR.in /data/mewes1/CALC/tadf/DONORS/DiEt_ACR.out DiEt_ACR.out.plots
else
$QC/bin/qchem DiEt_ACR.in /data/mewes1/CALC/tadf/DONORS/DiEt_ACR.out
fi
