...
#SBATCH --job-name=.data.mewes1.CALC.tadf.DONORS.NaMe.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/DONORS/NaMe.in /data/mewes1/CALC/tadf/DONORS/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/DONORS/NaMe.out ] && cp /data/mewes1/CALC/tadf/DONORS/NaMe.out /data/mewes1/CALC/tadf/DONORS/NaMe.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save NaMe.in /data/mewes1/CALC/tadf/DONORS/NaMe.out NaMe.out.plots
else
$QC/bin/qchem NaMe.in /data/mewes1/CALC/tadf/DONORS/NaMe.out
fi
