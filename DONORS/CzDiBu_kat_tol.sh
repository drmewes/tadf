...
#SBATCH --job-name=dCALC.TADF.DONORS.CzDiBu_kat_tol.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/DONORS/CzDiBu_kat_tol.in /data/mewes/CALC/TADF/DONORS/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/DONORS/CzDiBu_kat_tol.out ] && cp /data/mewes/CALC/TADF/DONORS/CzDiBu_kat_tol.out /data/mewes/CALC/TADF/DONORS/CzDiBu_kat_tol.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save CzDiBu_kat_tol.in /data/mewes/CALC/TADF/DONORS/CzDiBu_kat_tol.out CzDiBu_kat_tol.out.plots
else
$QC/bin/qchem CzDiBu_kat_tol.in /data/mewes/CALC/TADF/DONORS/CzDiBu_kat_tol.out
fi
