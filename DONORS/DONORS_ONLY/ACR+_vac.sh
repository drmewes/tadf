...
#SBATCH --job-name=.data.mewes1.CALC.tadf.DONORS.DONORS_ONLY.ACR+_vac.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/ACR+_vac.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/ACR+_vac.out ] && cp /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/ACR+_vac.out /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/ACR+_vac.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save ACR+_vac.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/ACR+_vac.out ACR+_vac.out.plots
else
$QC/bin/qchem ACR+_vac.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/ACR+_vac.out
fi
