...
#SBATCH --job-name=.data.mewes1.CALC.tadf.DONORS.DONORS_ONLY.NPh2.in
#SBATCH -t 0-12:00
#SBATCH -n 4
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/NPh2.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/NPh2.out ] && cp /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/NPh2.out /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/NPh2.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save NPh2.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/NPh2.out NPh2.out.plots
else
$QC/bin/qchem NPh2.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/NPh2.out
fi
