...
#SBATCH --job-name=.data.mewes1.CALC.tadf.DONORS.DONORS_ONLY.PXZ.in
#SBATCH -t 0-12:00
#SBATCH -n 4
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/PXZ.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/PXZ.out ] && cp /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/PXZ.out /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/PXZ.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save PXZ.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/PXZ.out PXZ.out.plots
else
$QC/bin/qchem PXZ.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/PXZ.out
fi
