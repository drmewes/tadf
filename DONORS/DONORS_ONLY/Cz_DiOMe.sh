...
#SBATCH --job-name=.data.mewes1.CALC.tadf.DONORS.DONORS_ONLY.Cz_DiOMe.in
#SBATCH -t 0-12:00
#SBATCH -n 4
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/Cz_DiOMe.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/Cz_DiOMe.out ] && cp /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/Cz_DiOMe.out /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/Cz_DiOMe.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save Cz_DiOMe.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/Cz_DiOMe.out Cz_DiOMe.out.plots
else
$QC/bin/qchem Cz_DiOMe.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/Cz_DiOMe.out
fi
