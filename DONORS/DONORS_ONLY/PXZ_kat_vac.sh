...
#SBATCH --job-name=.data.mewes1.CALC.tadf.DONORS.DONORS_ONLY.PXZ_kat_vac.in
#SBATCH -t 0-12:00
#SBATCH -n 4
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/PXZ_kat_vac.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/PXZ_kat_vac.out ] && cp /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/PXZ_kat_vac.out /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/PXZ_kat_vac.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save PXZ_kat_vac.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/PXZ_kat_vac.out PXZ_kat_vac.out.plots
else
$QC/bin/qchem PXZ_kat_vac.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/PXZ_kat_vac.out
fi
