...
#SBATCH --job-name=.data.mewes1.CALC.tadf.DONORS.DONORS_ONLY.DPTZ.in
#SBATCH -t 0-12:00
#SBATCH -n 4
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/DPTZ.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/DPTZ.out ] && cp /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/DPTZ.out /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/DPTZ.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save DPTZ.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/DPTZ.out DPTZ.out.plots
else
$QC/bin/qchem DPTZ.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/DPTZ.out
fi
