...
#SBATCH --job-name=.data.mewes1.CALC.tadf.DONORS.DONORS_ONLY.PPZ.in
#SBATCH -t 0-12:00
#SBATCH -n 4
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/PPZ.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/PPZ.out ] && cp /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/PPZ.out /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/PPZ.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save PPZ.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/PPZ.out PPZ.out.plots
else
$QC/bin/qchem PPZ.in /data/mewes1/CALC/tadf/DONORS/DONORS_ONLY/PPZ.out
fi
