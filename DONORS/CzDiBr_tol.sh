...
#SBATCH --job-name=dCALC.TADF.DONORS.CzDiBr_tol.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/DONORS/CzDiBr_tol.in /data/mewes/CALC/TADF/DONORS/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/DONORS/CzDiBr_tol.out ] && cp /data/mewes/CALC/TADF/DONORS/CzDiBr_tol.out /data/mewes/CALC/TADF/DONORS/CzDiBr_tol.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save CzDiBr_tol.in /data/mewes/CALC/TADF/DONORS/CzDiBr_tol.out CzDiBr_tol.out.plots
else
$QC/bin/qchem CzDiBr_tol.in /data/mewes/CALC/TADF/DONORS/CzDiBr_tol.out
fi
