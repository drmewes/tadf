...
#SBATCH --job-name=.data.mewes1.CALC.tadf.DONORS.MeEt_NPh3_kat_tol.in
#SBATCH -t 0-12:00
#SBATCH -n 4
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/DONORS/MeEt_NPh3_kat_tol.in /data/mewes1/CALC/tadf/DONORS/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/DONORS/MeEt_NPh3_kat_tol.out ] && cp /data/mewes1/CALC/tadf/DONORS/MeEt_NPh3_kat_tol.out /data/mewes1/CALC/tadf/DONORS/MeEt_NPh3_kat_tol.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save MeEt_NPh3_kat_tol.in /data/mewes1/CALC/tadf/DONORS/MeEt_NPh3_kat_tol.out MeEt_NPh3_kat_tol.out.plots
else
$QC/bin/qchem MeEt_NPh3_kat_tol.in /data/mewes1/CALC/tadf/DONORS/MeEt_NPh3_kat_tol.out
fi
