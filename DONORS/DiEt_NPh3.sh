...
#SBATCH --job-name=.data.mewes1.CALC.tadf.DONORS.DiEt_NPh3.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/DONORS/DiEt_NPh3.in /data/mewes1/CALC/tadf/DONORS/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/DONORS/DiEt_NPh3.out ] && cp /data/mewes1/CALC/tadf/DONORS/DiEt_NPh3.out /data/mewes1/CALC/tadf/DONORS/DiEt_NPh3.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save DiEt_NPh3.in /data/mewes1/CALC/tadf/DONORS/DiEt_NPh3.out DiEt_NPh3.out.plots
else
$QC/bin/qchem DiEt_NPh3.in /data/mewes1/CALC/tadf/DONORS/DiEt_NPh3.out
fi
