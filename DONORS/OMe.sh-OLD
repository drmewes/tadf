...
#SBATCH --job-name=.data.mewes1.CALC.tadf.DONORS.OMe.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/DONORS/OMe.in /data/mewes1/CALC/tadf/DONORS/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/DONORS/OMe.out ] && cp /data/mewes1/CALC/tadf/DONORS/OMe.out /data/mewes1/CALC/tadf/DONORS/OMe.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save OMe.in /data/mewes1/CALC/tadf/DONORS/OMe.out OMe.out.plots
else
$QC/bin/qchem OMe.in /data/mewes1/CALC/tadf/DONORS/OMe.out
fi
