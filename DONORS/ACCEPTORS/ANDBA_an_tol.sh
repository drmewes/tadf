...
#SBATCH --job-name=dCALC.tadf.DONORS.ACCEPTORS.ANDBA_an_tol.in
#SBATCH -t 0-12:00
#SBATCH -n 4
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/DONORS/ACCEPTORS/ANDBA_an_tol.in /data/mewes1/CALC/tadf/DONORS/ACCEPTORS/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/DONORS/ACCEPTORS/ANDBA_an_tol.out ] && cp /data/mewes1/CALC/tadf/DONORS/ACCEPTORS/ANDBA_an_tol.out /data/mewes1/CALC/tadf/DONORS/ACCEPTORS/ANDBA_an_tol.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save ANDBA_an_tol.in /data/mewes1/CALC/tadf/DONORS/ACCEPTORS/ANDBA_an_tol.out ANDBA_an_tol.out.plots
else
$QC/bin/qchem ANDBA_an_tol.in /data/mewes1/CALC/tadf/DONORS/ACCEPTORS/ANDBA_an_tol.out
fi
