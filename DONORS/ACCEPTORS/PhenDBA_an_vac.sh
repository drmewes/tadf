...
#SBATCH --job-name=dCALC.tadf.DONORS.ACCEPTORS.PhenDBA_an_vac.in
#SBATCH -t 0-12:00
#SBATCH -n 4
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/DONORS/ACCEPTORS/PhenDBA_an_vac.in /data/mewes1/CALC/tadf/DONORS/ACCEPTORS/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/DONORS/ACCEPTORS/PhenDBA_an_vac.out ] && cp /data/mewes1/CALC/tadf/DONORS/ACCEPTORS/PhenDBA_an_vac.out /data/mewes1/CALC/tadf/DONORS/ACCEPTORS/PhenDBA_an_vac.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save PhenDBA_an_vac.in /data/mewes1/CALC/tadf/DONORS/ACCEPTORS/PhenDBA_an_vac.out PhenDBA_an_vac.out.plots
else
$QC/bin/qchem PhenDBA_an_vac.in /data/mewes1/CALC/tadf/DONORS/ACCEPTORS/PhenDBA_an_vac.out
fi
