...
#SBATCH --job-name=.data.mewes1.CALC.tadf.DONORS.DiEt_PXZ.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/DONORS/DiEt_PXZ.in /data/mewes1/CALC/tadf/DONORS/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/DONORS/DiEt_PXZ.out ] && cp /data/mewes1/CALC/tadf/DONORS/DiEt_PXZ.out /data/mewes1/CALC/tadf/DONORS/DiEt_PXZ.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save DiEt_PXZ.in /data/mewes1/CALC/tadf/DONORS/DiEt_PXZ.out DiEt_PXZ.out.plots
else
$QC/bin/qchem DiEt_PXZ.in /data/mewes1/CALC/tadf/DONORS/DiEt_PXZ.out
fi
