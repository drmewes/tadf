...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-OMe/orca_mos.in /data/mewes/CALC/TADF/ANDBA-OMe/*.hess /data/mewes/CALC/TADF/ANDBA-OMe/*.gbw /data/mewes/CALC/TADF/ANDBA-OMe/*.xyz .

# Execute the program
$ORCA_PATH/orca orca_mos.in > /data/mewes/CALC/TADF/ANDBA-OMe/orca_mos.out
