...
#SBATCH --job-name=dCALC.TADF.ANDBA-OMe.GSOPT+PCM.gsopt_eth.in
#SBATCH -t 3-0:00
#SBATCH -n 4
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-OMe/GSOPT+PCM/gsopt_eth.in /data/mewes/CALC/TADF/ANDBA-OMe/GSOPT+PCM/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA-OMe/GSOPT+PCM/gsopt_eth.out ] && cp /data/mewes/CALC/TADF/ANDBA-OMe/GSOPT+PCM/gsopt_eth.out /data/mewes/CALC/TADF/ANDBA-OMe/GSOPT+PCM/gsopt_eth.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 gsopt_eth.in /data/mewes/CALC/TADF/ANDBA-OMe/GSOPT+PCM/gsopt_eth.out gsopt_eth.out.plots
else
$QC/bin/qchem -np 1 gsopt_eth.in /data/mewes/CALC/TADF/ANDBA-OMe/GSOPT+PCM/gsopt_eth.out
fi
