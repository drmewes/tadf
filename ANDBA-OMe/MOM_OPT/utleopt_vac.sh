...
#SBATCH --job-name=dCALC.TADF.ANDBA-OMe.MOM_OPT.utleopt_vac.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-OMe/MOM_OPT/utleopt_vac.in /data/mewes/CALC/TADF/ANDBA-OMe/MOM_OPT/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA-OMe/MOM_OPT/utleopt_vac.out ] && cp /data/mewes/CALC/TADF/ANDBA-OMe/MOM_OPT/utleopt_vac.out /data/mewes/CALC/TADF/ANDBA-OMe/MOM_OPT/utleopt_vac.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 utleopt_vac.in /data/mewes/CALC/TADF/ANDBA-OMe/MOM_OPT/utleopt_vac.out utleopt_vac.out.plots
else
$QC/bin/qchem -np 1 utleopt_vac.in /data/mewes/CALC/TADF/ANDBA-OMe/MOM_OPT/utleopt_vac.out
fi
