...
#SBATCH --job-name=dCALC.TADF.ADDUCTs.DME.dme.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ADDUCTs/DME/dme.in /data/mewes/CALC/TADF/ADDUCTs/DME/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ADDUCTs/DME/dme.out ] && cp /data/mewes/CALC/TADF/ADDUCTs/DME/dme.out /data/mewes/CALC/TADF/ADDUCTs/DME/dme.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save dme.in /data/mewes/CALC/TADF/ADDUCTs/DME/dme.out dme.out.plots
else
$QC/bin/qchem dme.in /data/mewes/CALC/TADF/ADDUCTs/DME/dme.out
fi
