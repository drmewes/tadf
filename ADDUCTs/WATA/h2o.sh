...
#SBATCH --job-name=dCALC.TADF.ADDUCTs.WATA.h2o.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ADDUCTs/WATA/h2o.in /data/mewes/CALC/TADF/ADDUCTs/WATA/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ADDUCTs/WATA/h2o.out ] && cp /data/mewes/CALC/TADF/ADDUCTs/WATA/h2o.out /data/mewes/CALC/TADF/ADDUCTs/WATA/h2o.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save h2o.in /data/mewes/CALC/TADF/ADDUCTs/WATA/h2o.out h2o.out.plots
else
$QC/bin/qchem h2o.in /data/mewes/CALC/TADF/ADDUCTs/WATA/h2o.out
fi
