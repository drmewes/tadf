...
#SBATCH --job-name=dCALC.TADF.ADDUCTs.MECN.PCM.mecn.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ADDUCTs/MECN/PCM/mecn.in /data/mewes/CALC/TADF/ADDUCTs/MECN/PCM/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ADDUCTs/MECN/PCM/mecn.out ] && cp /data/mewes/CALC/TADF/ADDUCTs/MECN/PCM/mecn.out /data/mewes/CALC/TADF/ADDUCTs/MECN/PCM/mecn.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save mecn.in /data/mewes/CALC/TADF/ADDUCTs/MECN/PCM/mecn.out mecn.out.plots
else
$QC/bin/qchem mecn.in /data/mewes/CALC/TADF/ADDUCTs/MECN/PCM/mecn.out
fi
