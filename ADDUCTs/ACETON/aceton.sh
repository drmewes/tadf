...
#SBATCH --job-name=dCALC.TADF.ADDUCTs.ACETON.aceton.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ADDUCTs/ACETON/aceton.in /data/mewes/CALC/TADF/ADDUCTs/ACETON/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ADDUCTs/ACETON/aceton.out ] && cp /data/mewes/CALC/TADF/ADDUCTs/ACETON/aceton.out /data/mewes/CALC/TADF/ADDUCTs/ACETON/aceton.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save aceton.in /data/mewes/CALC/TADF/ADDUCTs/ACETON/aceton.out aceton.out.plots
else
$QC/bin/qchem aceton.in /data/mewes/CALC/TADF/ADDUCTs/ACETON/aceton.out
fi
