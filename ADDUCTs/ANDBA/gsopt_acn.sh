...
#SBATCH --job-name=dCALC.TADF.ADDUCTs.ANDBA.gsopt_acn.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ADDUCTs/ANDBA/gsopt_acn.in /data/mewes/CALC/TADF/ADDUCTs/ANDBA/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ADDUCTs/ANDBA/gsopt_acn.out ] && cp /data/mewes/CALC/TADF/ADDUCTs/ANDBA/gsopt_acn.out /data/mewes/CALC/TADF/ADDUCTs/ANDBA/gsopt_acn.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save gsopt_acn.in /data/mewes/CALC/TADF/ADDUCTs/ANDBA/gsopt_acn.out gsopt_acn.out.plots
else
$QC/bin/qchem gsopt_acn.in /data/mewes/CALC/TADF/ADDUCTs/ANDBA/gsopt_acn.out
fi
