...
#SBATCH --job-name=dCALC.TADF.PhenDBA-DiEt-DMAc.GSOPT+PCM.gsopt_eth.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/PhenDBA-DiEt-DMAc/GSOPT+PCM/gsopt_eth.in /data/mewes/CALC/TADF/PhenDBA-DiEt-DMAc/GSOPT+PCM/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/PhenDBA-DiEt-DMAc/GSOPT+PCM/gsopt_eth.out ] && cp /data/mewes/CALC/TADF/PhenDBA-DiEt-DMAc/GSOPT+PCM/gsopt_eth.out /data/mewes/CALC/TADF/PhenDBA-DiEt-DMAc/GSOPT+PCM/gsopt_eth.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save gsopt_eth.in /data/mewes/CALC/TADF/PhenDBA-DiEt-DMAc/GSOPT+PCM/gsopt_eth.out gsopt_eth.out.plots
else
$QC/bin/qchem gsopt_eth.in /data/mewes/CALC/TADF/PhenDBA-DiEt-DMAc/GSOPT+PCM/gsopt_eth.out
fi
