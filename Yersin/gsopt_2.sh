...
#SBATCH --job-name=TADF.Yersin.gsopt_2.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /home/mewes/CALC/TADF/Yersin/gsopt_2.in /home/mewes/CALC/TADF/Yersin/*.mol .

# Backup old out file is existing 
[ -e /home/mewes/CALC/TADF/Yersin/gsopt_2.out ] && cp /home/mewes/CALC/TADF/Yersin/gsopt_2.out /home/mewes/CALC/TADF/Yersin/gsopt_2.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 gsopt_2.in /home/mewes/CALC/TADF/Yersin/gsopt_2.out gsopt_2.out.plots
else
$QC/bin/qchem -np 1 gsopt_2.in /home/mewes/CALC/TADF/Yersin/gsopt_2.out
fi
