...
#SBATCH --job-name=dCALC.TADF_OLD.Yersin.sCT_F2A_opt.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF_OLD/Yersin/sCT_F2A_opt.in /data/mewes/CALC/TADF_OLD/Yersin/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF_OLD/Yersin/sCT_F2A_opt.out ] && cp /data/mewes/CALC/TADF_OLD/Yersin/sCT_F2A_opt.out /data/mewes/CALC/TADF_OLD/Yersin/sCT_F2A_opt.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save sCT_F2A_opt.in /data/mewes/CALC/TADF_OLD/Yersin/sCT_F2A_opt.out sCT_F2A_opt.out.plots
else
$QC/bin/qchem sCT_F2A_opt.in /data/mewes/CALC/TADF_OLD/Yersin/sCT_F2A_opt.out
fi
