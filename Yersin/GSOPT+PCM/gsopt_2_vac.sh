...
#SBATCH --job-name=dCALC.TADF_OLD.Yersin.GSOPT+PCM.gsopt_2_vac.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF_OLD/Yersin/GSOPT+PCM/gsopt_2_vac.in /data/mewes/CALC/TADF_OLD/Yersin/GSOPT+PCM/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF_OLD/Yersin/GSOPT+PCM/gsopt_2_vac.out ] && cp /data/mewes/CALC/TADF_OLD/Yersin/GSOPT+PCM/gsopt_2_vac.out /data/mewes/CALC/TADF_OLD/Yersin/GSOPT+PCM/gsopt_2_vac.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save gsopt_2_vac.in /data/mewes/CALC/TADF_OLD/Yersin/GSOPT+PCM/gsopt_2_vac.out gsopt_2_vac.out.plots
else
$QC/bin/qchem gsopt_2_vac.in /data/mewes/CALC/TADF_OLD/Yersin/GSOPT+PCM/gsopt_2_vac.out
fi
