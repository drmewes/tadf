...
#SBATCH --job-name=TADF.Yersin.gsopt.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /home/mewes/CALC/TADF/Yersin/gsopt.in /home/mewes/CALC/TADF/Yersin/*.mol .

# Backup old out file is existing 
[ -e /home/mewes/CALC/TADF/Yersin/gsopt.out ] && cp /home/mewes/CALC/TADF/Yersin/gsopt.out /home/mewes/CALC/TADF/Yersin/gsopt.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 gsopt.in /home/mewes/CALC/TADF/Yersin/gsopt.out gsopt.out.plots
else
$QC/bin/qchem -np 1 gsopt.in /home/mewes/CALC/TADF/Yersin/gsopt.out
fi
