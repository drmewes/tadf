...
#SBATCH --job-name=TADF.Yersin.s1opt_tda_soc_rlx.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /home/mewes/CALC/TADF/Yersin/s1opt_tda_soc_rlx.in /home/mewes/CALC/TADF/Yersin/*.mol .

# Backup old out file is existing 
[ -e /home/mewes/CALC/TADF/Yersin/s1opt_tda_soc_rlx.out ] && cp /home/mewes/CALC/TADF/Yersin/s1opt_tda_soc_rlx.out /home/mewes/CALC/TADF/Yersin/s1opt_tda_soc_rlx.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 s1opt_tda_soc_rlx.in /home/mewes/CALC/TADF/Yersin/s1opt_tda_soc_rlx.out s1opt_tda_soc_rlx.out.plots
else
$QC/bin/qchem -np 1 s1opt_tda_soc_rlx.in /home/mewes/CALC/TADF/Yersin/s1opt_tda_soc_rlx.out
fi
