...
#SBATCH --job-name=dCALC.TADF.Yersin.PLOTS.t1opt_tda_splots.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/Yersin/PLOTS/t1opt_tda_splots.in /data/mewes/CALC/TADF/Yersin/PLOTS/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/Yersin/PLOTS/t1opt_tda_splots.out ] && cp /data/mewes/CALC/TADF/Yersin/PLOTS/t1opt_tda_splots.out /data/mewes/CALC/TADF/Yersin/PLOTS/t1opt_tda_splots.out_OLD

# Execute the program
if [ "yes" = "yes" ] ; then
$QC/bin/qchem -save t1opt_tda_splots.in /data/mewes/CALC/TADF/Yersin/PLOTS/t1opt_tda_splots.out t1opt_tda_splots.out.plots
else
$QC/bin/qchem t1opt_tda_splots.in /data/mewes/CALC/TADF/Yersin/PLOTS/t1opt_tda_splots.out
fi
