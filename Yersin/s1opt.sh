...
#SBATCH --job-name=TADF.Yersin.s1opt.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /home/mewes/CALC/TADF/Yersin/s1opt.in /home/mewes/CALC/TADF/Yersin/*.mol .

# Backup old out file is existing 
[ -e /home/mewes/CALC/TADF/Yersin/s1opt.out ] && cp /home/mewes/CALC/TADF/Yersin/s1opt.out /home/mewes/CALC/TADF/Yersin/s1opt.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 s1opt.in /home/mewes/CALC/TADF/Yersin/s1opt.out s1opt.out.plots
else
$QC/bin/qchem -np 1 s1opt.in /home/mewes/CALC/TADF/Yersin/s1opt.out
fi
