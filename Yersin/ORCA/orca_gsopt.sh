...
# Go into Scratch
cd $SCRATCH
cp /home/mewes/CALC/TADF/Yersin/orca_gsopt.in /home/mewes/CALC/TADF/Yersin/*.hess /home/mewes/CALC/TADF/Yersin/*.gbw .

# Execute the program
$ORCA_PATH/orca orca_gsopt.in > /home/mewes/CALC/TADF/Yersin/orca_gsopt.out
