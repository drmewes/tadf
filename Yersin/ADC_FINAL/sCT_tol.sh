...
#SBATCH --job-name=dCALC.TADF_OLD.Yersin.ADC_FINAL.sCT_tol.in
#SBATCH -t 5-0:00
#SBATCH -n 26
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF_OLD/Yersin/ADC_FINAL/sCT_tol.in /data/mewes/CALC/TADF_OLD/Yersin/ADC_FINAL/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF_OLD/Yersin/ADC_FINAL/sCT_tol.out ] && cp /data/mewes/CALC/TADF_OLD/Yersin/ADC_FINAL/sCT_tol.out /data/mewes/CALC/TADF_OLD/Yersin/ADC_FINAL/sCT_tol.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save sCT_tol.in /data/mewes/CALC/TADF_OLD/Yersin/ADC_FINAL/sCT_tol.out sCT_tol.out.plots
else
$QC/bin/qchem sCT_tol.in /data/mewes/CALC/TADF_OLD/Yersin/ADC_FINAL/sCT_tol.out
fi
