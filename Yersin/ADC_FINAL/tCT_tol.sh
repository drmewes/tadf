...
#SBATCH --job-name=dCALC.TADF_OLD.Yersin.ADC_FINAL.tCT_tol.in
#SBATCH -t 5-0:00
#SBATCH -n 26
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF_OLD/Yersin/ADC_FINAL/tCT_tol.in /data/mewes/CALC/TADF_OLD/Yersin/ADC_FINAL/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF_OLD/Yersin/ADC_FINAL/tCT_tol.out ] && cp /data/mewes/CALC/TADF_OLD/Yersin/ADC_FINAL/tCT_tol.out /data/mewes/CALC/TADF_OLD/Yersin/ADC_FINAL/tCT_tol.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save tCT_tol.in /data/mewes/CALC/TADF_OLD/Yersin/ADC_FINAL/tCT_tol.out tCT_tol.out.plots
else
$QC/bin/qchem tCT_tol.in /data/mewes/CALC/TADF_OLD/Yersin/ADC_FINAL/tCT_tol.out
fi
