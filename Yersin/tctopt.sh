...
#SBATCH --job-name=TADF.Yersin.tctopt.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /home/mewes/CALC/TADF/Yersin/tctopt.in /home/mewes/CALC/TADF/Yersin/*.mol .

# Backup old out file is existing 
[ -e /home/mewes/CALC/TADF/Yersin/tctopt.out ] && cp /home/mewes/CALC/TADF/Yersin/tctopt.out /home/mewes/CALC/TADF/Yersin/tctopt.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 tctopt.in /home/mewes/CALC/TADF/Yersin/tctopt.out tctopt.out.plots
else
$QC/bin/qchem -np 1 tctopt.in /home/mewes/CALC/TADF/Yersin/tctopt.out
fi
