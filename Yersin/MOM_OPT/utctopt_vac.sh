...
#SBATCH --job-name=TADF.Yersin.MOM_OPT.utctopt_vac.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /home/mewes/CALC/TADF/Yersin/MOM_OPT/utctopt_vac.in /home/mewes/CALC/TADF/Yersin/MOM_OPT/*.mol .

# Backup old out file is existing 
[ -e /home/mewes/CALC/TADF/Yersin/MOM_OPT/utctopt_vac.out ] && cp /home/mewes/CALC/TADF/Yersin/MOM_OPT/utctopt_vac.out /home/mewes/CALC/TADF/Yersin/MOM_OPT/utctopt_vac.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 utctopt_vac.in /home/mewes/CALC/TADF/Yersin/MOM_OPT/utctopt_vac.out utctopt_vac.out.plots
else
$QC/bin/qchem -np 1 utctopt_vac.in /home/mewes/CALC/TADF/Yersin/MOM_OPT/utctopt_vac.out
fi
