...
#SBATCH --job-name=TADF.Yersin.MOM_OPT.ut1opt_eth.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /home/mewes/CALC/TADF/Yersin/MOM_OPT/ut1opt_eth.in /home/mewes/CALC/TADF/Yersin/MOM_OPT/*.mol .

# Backup old out file is existing 
[ -e /home/mewes/CALC/TADF/Yersin/MOM_OPT/ut1opt_eth.out ] && cp /home/mewes/CALC/TADF/Yersin/MOM_OPT/ut1opt_eth.out /home/mewes/CALC/TADF/Yersin/MOM_OPT/ut1opt_eth.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 ut1opt_eth.in /home/mewes/CALC/TADF/Yersin/MOM_OPT/ut1opt_eth.out ut1opt_eth.out.plots
else
$QC/bin/qchem -np 1 ut1opt_eth.in /home/mewes/CALC/TADF/Yersin/MOM_OPT/ut1opt_eth.out
fi
