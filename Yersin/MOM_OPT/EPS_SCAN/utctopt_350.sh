...
#SBATCH --job-name=dCALC.TADF.Yersin.MOM_OPT.EPS_SCAN.utctopt_350.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/Yersin/MOM_OPT/EPS_SCAN/utctopt_350.in /data/mewes/CALC/TADF/Yersin/MOM_OPT/EPS_SCAN/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/Yersin/MOM_OPT/EPS_SCAN/utctopt_350.out ] && cp /data/mewes/CALC/TADF/Yersin/MOM_OPT/EPS_SCAN/utctopt_350.out /data/mewes/CALC/TADF/Yersin/MOM_OPT/EPS_SCAN/utctopt_350.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save utctopt_350.in /data/mewes/CALC/TADF/Yersin/MOM_OPT/EPS_SCAN/utctopt_350.out utctopt_350.out.plots
else
$QC/bin/qchem utctopt_350.in /data/mewes/CALC/TADF/Yersin/MOM_OPT/EPS_SCAN/utctopt_350.out
fi
