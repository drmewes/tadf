...
#SBATCH --job-name=dCALC.TADF_OLD.Yersin.MOM_OPT.ut1opt_300.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF_OLD/Yersin/MOM_OPT/ut1opt_300.in /data/mewes/CALC/TADF_OLD/Yersin/MOM_OPT/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF_OLD/Yersin/MOM_OPT/ut1opt_300.out ] && cp /data/mewes/CALC/TADF_OLD/Yersin/MOM_OPT/ut1opt_300.out /data/mewes/CALC/TADF_OLD/Yersin/MOM_OPT/ut1opt_300.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 ut1opt_300.in /data/mewes/CALC/TADF_OLD/Yersin/MOM_OPT/ut1opt_300.out ut1opt_300.out.plots
else
$QC/bin/qchem -np 1 ut1opt_300.in /data/mewes/CALC/TADF_OLD/Yersin/MOM_OPT/ut1opt_300.out
fi
