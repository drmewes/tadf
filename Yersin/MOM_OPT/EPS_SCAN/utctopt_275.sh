...
#SBATCH --job-name=dCALC.TADF.Yersin.MOM_OPT.EPS_SCAN.utctopt_275.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/Yersin/MOM_OPT/EPS_SCAN/utctopt_275.in /data/mewes/CALC/TADF/Yersin/MOM_OPT/EPS_SCAN/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/Yersin/MOM_OPT/EPS_SCAN/utctopt_275.out ] && cp /data/mewes/CALC/TADF/Yersin/MOM_OPT/EPS_SCAN/utctopt_275.out /data/mewes/CALC/TADF/Yersin/MOM_OPT/EPS_SCAN/utctopt_275.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save utctopt_275.in /data/mewes/CALC/TADF/Yersin/MOM_OPT/EPS_SCAN/utctopt_275.out utctopt_275.out.plots
else
$QC/bin/qchem utctopt_275.in /data/mewes/CALC/TADF/Yersin/MOM_OPT/EPS_SCAN/utctopt_275.out
fi
