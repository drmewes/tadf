...
#SBATCH --job-name=TADF.Yersin.MOM_OPT.utctopt_dcm.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /home/mewes/CALC/TADF/Yersin/MOM_OPT/utctopt_dcm.in /home/mewes/CALC/TADF/Yersin/MOM_OPT/*.mol .

# Backup old out file is existing 
[ -e /home/mewes/CALC/TADF/Yersin/MOM_OPT/utctopt_dcm.out ] && cp /home/mewes/CALC/TADF/Yersin/MOM_OPT/utctopt_dcm.out /home/mewes/CALC/TADF/Yersin/MOM_OPT/utctopt_dcm.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 utctopt_dcm.in /home/mewes/CALC/TADF/Yersin/MOM_OPT/utctopt_dcm.out utctopt_dcm.out.plots
else
$QC/bin/qchem -np 1 utctopt_dcm.in /home/mewes/CALC/TADF/Yersin/MOM_OPT/utctopt_dcm.out
fi
