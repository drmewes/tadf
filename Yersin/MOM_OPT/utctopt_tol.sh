...
#SBATCH --job-name=TADF.Yersin.MOM_OPT.utctopt_tol.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /home/mewes/CALC/TADF/Yersin/MOM_OPT/utctopt_tol.in /home/mewes/CALC/TADF/Yersin/MOM_OPT/*.mol .

# Backup old out file is existing 
[ -e /home/mewes/CALC/TADF/Yersin/MOM_OPT/utctopt_tol.out ] && cp /home/mewes/CALC/TADF/Yersin/MOM_OPT/utctopt_tol.out /home/mewes/CALC/TADF/Yersin/MOM_OPT/utctopt_tol.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 utctopt_tol.in /home/mewes/CALC/TADF/Yersin/MOM_OPT/utctopt_tol.out utctopt_tol.out.plots
else
$QC/bin/qchem -np 1 utctopt_tol.in /home/mewes/CALC/TADF/Yersin/MOM_OPT/utctopt_tol.out
fi
