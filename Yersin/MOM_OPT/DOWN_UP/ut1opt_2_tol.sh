...
#SBATCH --job-name=dCALC.TADF_OLD.Yersin.MOM_OPT.ut1opt_2_tol.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF_OLD/Yersin/MOM_OPT/ut1opt_2_tol.in /data/mewes/CALC/TADF_OLD/Yersin/MOM_OPT/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF_OLD/Yersin/MOM_OPT/ut1opt_2_tol.out ] && cp /data/mewes/CALC/TADF_OLD/Yersin/MOM_OPT/ut1opt_2_tol.out /data/mewes/CALC/TADF_OLD/Yersin/MOM_OPT/ut1opt_2_tol.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 ut1opt_2_tol.in /data/mewes/CALC/TADF_OLD/Yersin/MOM_OPT/ut1opt_2_tol.out ut1opt_2_tol.out.plots
else
$QC/bin/qchem -np 1 ut1opt_2_tol.in /data/mewes/CALC/TADF_OLD/Yersin/MOM_OPT/ut1opt_2_tol.out
fi
