...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-NaMe/orca_mos.in /data/mewes/CALC/TADF/ANDBA-NaMe/*.hess /data/mewes/CALC/TADF/ANDBA-NaMe/*.gbw /data/mewes/CALC/TADF/ANDBA-NaMe/*.xyz .

# Execute the program
$ORCA_PATH/orca orca_mos.in > /data/mewes/CALC/TADF/ANDBA-NaMe/orca_mos.out
