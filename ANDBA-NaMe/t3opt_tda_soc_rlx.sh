...
#SBATCH --job-name=dCALC.TADF.ANDBA-NaMe.t3opt_tda_soc_rlx.in
#SBATCH -t 3-0:00
#SBATCH -n 4
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-NaMe/t3opt_tda_soc_rlx.in /data/mewes/CALC/TADF/ANDBA-NaMe/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA-NaMe/t3opt_tda_soc_rlx.out ] && cp /data/mewes/CALC/TADF/ANDBA-NaMe/t3opt_tda_soc_rlx.out /data/mewes/CALC/TADF/ANDBA-NaMe/t3opt_tda_soc_rlx.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 t3opt_tda_soc_rlx.in /data/mewes/CALC/TADF/ANDBA-NaMe/t3opt_tda_soc_rlx.out t3opt_tda_soc_rlx.out.plots
else
$QC/bin/qchem -np 1 t3opt_tda_soc_rlx.in /data/mewes/CALC/TADF/ANDBA-NaMe/t3opt_tda_soc_rlx.out
fi
