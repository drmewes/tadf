...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-NaMe/t3opt.in /data/mewes/CALC/TADF/ANDBA-NaMe/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA-NaMe/t3opt.out ] && cp /data/mewes/CALC/TADF/ANDBA-NaMe/t3opt.out /data/mewes/CALC/TADF/ANDBA-NaMe/t3opt.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 t3opt.in /data/mewes/CALC/TADF/ANDBA-NaMe/t3opt.out t3opt.out.plots
else
$QC/bin/qchem -np 1 t3opt.in /data/mewes/CALC/TADF/ANDBA-NaMe/t3opt.out
fi
