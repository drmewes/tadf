...
#SBATCH --job-name=dCALC.TADF.ANDBA-NaMe.t3opt.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/TADF/ANDBA-NaMe/t3opt.in /data/mewes1/CALC/TADF/ANDBA-NaMe/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/TADF/ANDBA-NaMe/t3opt.out ] && cp /data/mewes1/CALC/TADF/ANDBA-NaMe/t3opt.out /data/mewes1/CALC/TADF/ANDBA-NaMe/t3opt.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 t3opt.in /data/mewes1/CALC/TADF/ANDBA-NaMe/t3opt.out t3opt.out.plots
else
$QC/bin/qchem -np 1 t3opt.in /data/mewes1/CALC/TADF/ANDBA-NaMe/t3opt.out
fi
