...
#SBATCH --job-name=dCALC.TADF.ANDBA-NaMe.gsopt.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/TADF/ANDBA-NaMe/gsopt.in /data/mewes1/CALC/TADF/ANDBA-NaMe/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/TADF/ANDBA-NaMe/gsopt.out ] && cp /data/mewes1/CALC/TADF/ANDBA-NaMe/gsopt.out /data/mewes1/CALC/TADF/ANDBA-NaMe/gsopt.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 gsopt.in /data/mewes1/CALC/TADF/ANDBA-NaMe/gsopt.out gsopt.out.plots
else
$QC/bin/qchem -np 1 gsopt.in /data/mewes1/CALC/TADF/ANDBA-NaMe/gsopt.out
fi
