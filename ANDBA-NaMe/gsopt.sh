...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-NaMe/gsopt.in /data/mewes/CALC/TADF/ANDBA-NaMe/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA-NaMe/gsopt.out ] && cp /data/mewes/CALC/TADF/ANDBA-NaMe/gsopt.out /data/mewes/CALC/TADF/ANDBA-NaMe/gsopt.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 gsopt.in /data/mewes/CALC/TADF/ANDBA-NaMe/gsopt.out gsopt.out.plots
else
$QC/bin/qchem -np 1 gsopt.in /data/mewes/CALC/TADF/ANDBA-NaMe/gsopt.out
fi
