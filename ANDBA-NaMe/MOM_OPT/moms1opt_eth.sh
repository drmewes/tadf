...
#SBATCH --job-name=dCALC.TADF.ANDBA-NaMe.MOM_OPT.moms1opt_eth.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/TADF/ANDBA-NaMe/MOM_OPT/moms1opt_eth.in /data/mewes1/CALC/TADF/ANDBA-NaMe/MOM_OPT/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/TADF/ANDBA-NaMe/MOM_OPT/moms1opt_eth.out ] && cp /data/mewes1/CALC/TADF/ANDBA-NaMe/MOM_OPT/moms1opt_eth.out /data/mewes1/CALC/TADF/ANDBA-NaMe/MOM_OPT/moms1opt_eth.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 moms1opt_eth.in /data/mewes1/CALC/TADF/ANDBA-NaMe/MOM_OPT/moms1opt_eth.out moms1opt_eth.out.plots
else
$QC/bin/qchem -np 1 moms1opt_eth.in /data/mewes1/CALC/TADF/ANDBA-NaMe/MOM_OPT/moms1opt_eth.out
fi
