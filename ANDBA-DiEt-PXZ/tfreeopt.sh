...
#SBATCH --job-name=dCALC.TADF.ANDBA-DiEt-PXZ.tfreeopt.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-DiEt-PXZ/tfreeopt.in /data/mewes/CALC/TADF/ANDBA-DiEt-PXZ/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA-DiEt-PXZ/tfreeopt.out ] && cp /data/mewes/CALC/TADF/ANDBA-DiEt-PXZ/tfreeopt.out /data/mewes/CALC/TADF/ANDBA-DiEt-PXZ/tfreeopt.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save tfreeopt.in /data/mewes/CALC/TADF/ANDBA-DiEt-PXZ/tfreeopt.out tfreeopt.out.plots
else
$QC/bin/qchem tfreeopt.in /data/mewes/CALC/TADF/ANDBA-DiEt-PXZ/tfreeopt.out
fi
