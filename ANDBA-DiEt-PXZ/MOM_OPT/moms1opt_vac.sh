...
#SBATCH --job-name=dCALC.TADF.ANDBA-DiEt-PXZ.MOM_OPT.moms1opt_vac.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-DiEt-PXZ/MOM_OPT/moms1opt_vac.in /data/mewes/CALC/TADF/ANDBA-DiEt-PXZ/MOM_OPT/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA-DiEt-PXZ/MOM_OPT/moms1opt_vac.out ] && cp /data/mewes/CALC/TADF/ANDBA-DiEt-PXZ/MOM_OPT/moms1opt_vac.out /data/mewes/CALC/TADF/ANDBA-DiEt-PXZ/MOM_OPT/moms1opt_vac.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save moms1opt_vac.in /data/mewes/CALC/TADF/ANDBA-DiEt-PXZ/MOM_OPT/moms1opt_vac.out moms1opt_vac.out.plots
else
$QC/bin/qchem moms1opt_vac.in /data/mewes/CALC/TADF/ANDBA-DiEt-PXZ/MOM_OPT/moms1opt_vac.out
fi
