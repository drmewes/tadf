...
#SBATCH --job-name=dCALC.TADF.ANDBA-OMe+MeEt.gsopt3.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-OMe+MeEt/gsopt3.in /data/mewes/CALC/TADF/ANDBA-OMe+MeEt/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA-OMe+MeEt/gsopt3.out ] && cp /data/mewes/CALC/TADF/ANDBA-OMe+MeEt/gsopt3.out /data/mewes/CALC/TADF/ANDBA-OMe+MeEt/gsopt3.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 gsopt3.in /data/mewes/CALC/TADF/ANDBA-OMe+MeEt/gsopt3.out gsopt3.out.plots
else
$QC/bin/qchem -np 1 gsopt3.in /data/mewes/CALC/TADF/ANDBA-OMe+MeEt/gsopt3.out
fi
