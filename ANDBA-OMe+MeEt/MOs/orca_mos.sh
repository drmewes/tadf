...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-OMe+MeEt/orca_mos.in /data/mewes/CALC/TADF/ANDBA-OMe+MeEt/*.hess /data/mewes/CALC/TADF/ANDBA-OMe+MeEt/*.gbw /data/mewes/CALC/TADF/ANDBA-OMe+MeEt/*.xyz .

# Execute the program
$ORCA_PATH/orca orca_mos.in > /data/mewes/CALC/TADF/ANDBA-OMe+MeEt/orca_mos.out
