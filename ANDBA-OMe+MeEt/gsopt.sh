...
#SBATCH --job-name=.data.mewes1.CALC.TADF.ANDBA-OMe+MeEt.gsopt.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/TADF/ANDBA-OMe+MeEt/gsopt.in /data/mewes1/CALC/TADF/ANDBA-OMe+MeEt/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/TADF/ANDBA-OMe+MeEt/gsopt.out ] && cp /data/mewes1/CALC/TADF/ANDBA-OMe+MeEt/gsopt.out /data/mewes1/CALC/TADF/ANDBA-OMe+MeEt/gsopt.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 gsopt.in /data/mewes1/CALC/TADF/ANDBA-OMe+MeEt/gsopt.out gsopt.out.plots
else
$QC/bin/qchem -np 1 gsopt.in /data/mewes1/CALC/TADF/ANDBA-OMe+MeEt/gsopt.out
fi
