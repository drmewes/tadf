...
#SBATCH --job-name=.data.mewes.CALC.TADF.ANDBA-DiEt-NPh3.gsopt_1.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-DiEt-NPh3/gsopt_1.in /data/mewes/CALC/TADF/ANDBA-DiEt-NPh3/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA-DiEt-NPh3/gsopt_1.out ] && cp /data/mewes/CALC/TADF/ANDBA-DiEt-NPh3/gsopt_1.out /data/mewes/CALC/TADF/ANDBA-DiEt-NPh3/gsopt_1.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save gsopt_1.in /data/mewes/CALC/TADF/ANDBA-DiEt-NPh3/gsopt_1.out gsopt_1.out.plots
else
$QC/bin/qchem gsopt_1.in /data/mewes/CALC/TADF/ANDBA-DiEt-NPh3/gsopt_1.out
fi
