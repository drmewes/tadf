...
#SBATCH --job-name=dCALC.TADF.ANDBA-OMe+Ethyl.CONFORMERS.gsopt5.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-OMe+Ethyl/CONFORMERS/gsopt5.in /data/mewes/CALC/TADF/ANDBA-OMe+Ethyl/CONFORMERS/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA-OMe+Ethyl/CONFORMERS/gsopt5.out ] && cp /data/mewes/CALC/TADF/ANDBA-OMe+Ethyl/CONFORMERS/gsopt5.out /data/mewes/CALC/TADF/ANDBA-OMe+Ethyl/CONFORMERS/gsopt5.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 gsopt5.in /data/mewes/CALC/TADF/ANDBA-OMe+Ethyl/CONFORMERS/gsopt5.out gsopt5.out.plots
else
$QC/bin/qchem -np 1 gsopt5.in /data/mewes/CALC/TADF/ANDBA-OMe+Ethyl/CONFORMERS/gsopt5.out
fi
