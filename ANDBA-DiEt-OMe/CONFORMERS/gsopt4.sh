...
#SBATCH --job-name=.data.mewes.CALC.TADF.ANDBA-DiEt-OMe.CONFORMERS.gsopt4.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/CONFORMERS/gsopt4.in /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/CONFORMERS/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/CONFORMERS/gsopt4.out ] && cp /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/CONFORMERS/gsopt4.out /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/CONFORMERS/gsopt4.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save gsopt4.in /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/CONFORMERS/gsopt4.out gsopt4.out.plots
else
$QC/bin/qchem gsopt4.in /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/CONFORMERS/gsopt4.out
fi
