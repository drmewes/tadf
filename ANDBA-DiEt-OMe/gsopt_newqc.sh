...
#SBATCH --job-name=.data.mewes.CALC.TADF.ANDBA-DiEt-OMe.gsopt_newqc.in
#SBATCH -t 1-0:00
#SBATCH -n 4
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/gsopt_newqc.in /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/gsopt_newqc.out ] && cp /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/gsopt_newqc.out /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/gsopt_newqc.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save gsopt_newqc.in /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/gsopt_newqc.out gsopt_newqc.out.plots
else
$QC/bin/qchem gsopt_newqc.in /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/gsopt_newqc.out
fi
