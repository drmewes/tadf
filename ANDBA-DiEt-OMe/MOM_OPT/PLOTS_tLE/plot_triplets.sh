...
#SBATCH --job-name=dCALC.TADF.ANDBA-DiEt-OMe.MOM_OPT.PLOTS_tLE.plot_triplets.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/MOM_OPT/PLOTS_tLE/plot_triplets.in /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/MOM_OPT/PLOTS_tLE/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/MOM_OPT/PLOTS_tLE/plot_triplets.out ] && cp /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/MOM_OPT/PLOTS_tLE/plot_triplets.out /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/MOM_OPT/PLOTS_tLE/plot_triplets.out_OLD

# Execute the program
if [ "yes" = "yes" ] ; then
$QC/bin/qchem -save plot_triplets.in /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/MOM_OPT/PLOTS_tLE/plot_triplets.out plot_triplets.out.plots
else
$QC/bin/qchem plot_triplets.in /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/MOM_OPT/PLOTS_tLE/plot_triplets.out
fi
