...
#SBATCH --job-name=.data.mewes.CALC.TADF.ANDBA-DiEt-OMe.s1opt2.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/s1opt2.in /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/s1opt2.out ] && cp /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/s1opt2.out /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/s1opt2.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save s1opt2.in /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/s1opt2.out s1opt2.out.plots
else
$QC/bin/qchem s1opt2.in /data/mewes/CALC/TADF/ANDBA-DiEt-OMe/s1opt2.out
fi
