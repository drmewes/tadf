...
#SBATCH --job-name=dCALC.tadf.ANDBA-DiEt-ACR.GSOPT+PCM.gsopt_eth.in
#SBATCH -t 3-0:00
#SBATCH -n 4
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/ANDBA-DiEt-ACR/GSOPT+PCM/gsopt_eth.in /data/mewes1/CALC/tadf/ANDBA-DiEt-ACR/GSOPT+PCM/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/ANDBA-DiEt-ACR/GSOPT+PCM/gsopt_eth.out ] && cp /data/mewes1/CALC/tadf/ANDBA-DiEt-ACR/GSOPT+PCM/gsopt_eth.out /data/mewes1/CALC/tadf/ANDBA-DiEt-ACR/GSOPT+PCM/gsopt_eth.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save gsopt_eth.in /data/mewes1/CALC/tadf/ANDBA-DiEt-ACR/GSOPT+PCM/gsopt_eth.out gsopt_eth.out.plots
else
$QC/bin/qchem gsopt_eth.in /data/mewes1/CALC/tadf/ANDBA-DiEt-ACR/GSOPT+PCM/gsopt_eth.out
fi
