...
#SBATCH --job-name=dCALC.TADF.ANDBA-DiEt-ACR.gsopt_tda_soc_rlx.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-DiEt-ACR/gsopt_tda_soc_rlx.in /data/mewes/CALC/TADF/ANDBA-DiEt-ACR/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA-DiEt-ACR/gsopt_tda_soc_rlx.out ] && cp /data/mewes/CALC/TADF/ANDBA-DiEt-ACR/gsopt_tda_soc_rlx.out /data/mewes/CALC/TADF/ANDBA-DiEt-ACR/gsopt_tda_soc_rlx.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save gsopt_tda_soc_rlx.in /data/mewes/CALC/TADF/ANDBA-DiEt-ACR/gsopt_tda_soc_rlx.out gsopt_tda_soc_rlx.out.plots
else
$QC/bin/qchem gsopt_tda_soc_rlx.in /data/mewes/CALC/TADF/ANDBA-DiEt-ACR/gsopt_tda_soc_rlx.out
fi
