...
#SBATCH --job-name=dCALC.TADF.ANDBA-DiEt-ACR.MOM_OPT.moms1opt_tol.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes/CALC/TADF/ANDBA-DiEt-ACR/MOM_OPT/moms1opt_tol.in /data/mewes/CALC/TADF/ANDBA-DiEt-ACR/MOM_OPT/*.mol .

# Backup old out file is existing 
[ -e /data/mewes/CALC/TADF/ANDBA-DiEt-ACR/MOM_OPT/moms1opt_tol.out ] && cp /data/mewes/CALC/TADF/ANDBA-DiEt-ACR/MOM_OPT/moms1opt_tol.out /data/mewes/CALC/TADF/ANDBA-DiEt-ACR/MOM_OPT/moms1opt_tol.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save moms1opt_tol.in /data/mewes/CALC/TADF/ANDBA-DiEt-ACR/MOM_OPT/moms1opt_tol.out moms1opt_tol.out.plots
else
$QC/bin/qchem moms1opt_tol.in /data/mewes/CALC/TADF/ANDBA-DiEt-ACR/MOM_OPT/moms1opt_tol.out
fi
