...
#SBATCH --job-name=.data.mewes1.CALC.tadf.PhenDBA.s1opt_tda_soc_rlx.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/PhenDBA/s1opt_tda_soc_rlx.in /data/mewes1/CALC/tadf/PhenDBA/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/PhenDBA/s1opt_tda_soc_rlx.out ] && cp /data/mewes1/CALC/tadf/PhenDBA/s1opt_tda_soc_rlx.out /data/mewes1/CALC/tadf/PhenDBA/s1opt_tda_soc_rlx.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save s1opt_tda_soc_rlx.in /data/mewes1/CALC/tadf/PhenDBA/s1opt_tda_soc_rlx.out s1opt_tda_soc_rlx.out.plots
else
$QC/bin/qchem s1opt_tda_soc_rlx.in /data/mewes1/CALC/tadf/PhenDBA/s1opt_tda_soc_rlx.out
fi
