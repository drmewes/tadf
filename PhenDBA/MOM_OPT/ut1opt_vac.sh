...
#SBATCH --job-name=dCALC.tadf.PhenDBA.MOM_OPT.ut1opt_vac.in
#SBATCH -t 3-0:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/PhenDBA/MOM_OPT/ut1opt_vac.in /data/mewes1/CALC/tadf/PhenDBA/MOM_OPT/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/PhenDBA/MOM_OPT/ut1opt_vac.out ] && cp /data/mewes1/CALC/tadf/PhenDBA/MOM_OPT/ut1opt_vac.out /data/mewes1/CALC/tadf/PhenDBA/MOM_OPT/ut1opt_vac.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save -np 1 ut1opt_vac.in /data/mewes1/CALC/tadf/PhenDBA/MOM_OPT/ut1opt_vac.out ut1opt_vac.out.plots
else
$QC/bin/qchem -np 1 ut1opt_vac.in /data/mewes1/CALC/tadf/PhenDBA/MOM_OPT/ut1opt_vac.out
fi
