...
#SBATCH --job-name=.data.mewes1.CALC.tadf.PhenDBA.gsopt.in
#SBATCH -t 0-12:00
#SBATCH -n 8
#SBATCH -N 1
...
# Go into Scratch
cd $SCRATCH
cp /data/mewes1/CALC/tadf/PhenDBA/gsopt.in /data/mewes1/CALC/tadf/PhenDBA/*.mol .

# Backup old out file is existing 
[ -e /data/mewes1/CALC/tadf/PhenDBA/gsopt.out ] && cp /data/mewes1/CALC/tadf/PhenDBA/gsopt.out /data/mewes1/CALC/tadf/PhenDBA/gsopt.out_OLD

# Execute the program
if [ "" = "yes" ] ; then
$QC/bin/qchem -save gsopt.in /data/mewes1/CALC/tadf/PhenDBA/gsopt.out gsopt.out.plots
else
$QC/bin/qchem gsopt.in /data/mewes1/CALC/tadf/PhenDBA/gsopt.out
fi
